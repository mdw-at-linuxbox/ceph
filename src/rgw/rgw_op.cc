...
ldout(s->cct,5) << "list_buckets: doing_cross_tenant: bt=" << buckets_user.tenant << dendl;
  } else {
ldout(s->cct,5) << "list_buckets: ! cross_tenant: bt=" << s->bucket_tenant <<
" at=" << s->account_name <<
" ut=" << s->user->user_id << dendl;
